<?php
/**
 * front-page.php — EN TOP
 *
 * サイトルート(/)は常にこのテンプレートで表示される(WPのテンプレート階層仕様上、
 * front-page.phpはSettings > Readingの設定に関係なくis_front_page()を最優先で捕捉する)。
 * Englishがデフォルト/ルート言語のため、EN TOPをここに置く。
 * JP TOPは page-front-ja.php(Template Name: JP TOP、/ja/ページに割当)側。
 *
