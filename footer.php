    ...
    <div class="site-footer__inner">
      <div class="site-footer__brand">
        ...
        <div class="site-footer__badges">
          <a href="<?php echo esc_url( LANGMATE_APPSTORE_URL ); ?>" target="_blank" rel="noopener"><img
          ...
          <a href="<?php echo esc_url( LANGMATE_GOOGLEPLAY_URL ); ?>" target="_blank" rel="noopener"><img
