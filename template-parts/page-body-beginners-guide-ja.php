...
<main id="main">
    ...
    <section class="gs-reason" id="reason" aria-labelledby="gs-reason-heading">
      ...
      <div class="gs-reason__inner">
              ...
              <div class="gs-reason__blob-wrap gs-reason__blob-wrap--03">
                ...
                <svg class="gs-reason__blob-label" viewBox="0 0 492 328" aria-hidden="true"
                  ...
                  <path id="gs-reason-path-03"
                    d="M15.0353 93.1381C57.438 39.6539 111.679 8.0518 180.521 2.24032C248.973 -3.54244 316.15 1.30436 381.552 23.4313C409.113 32.7568 435.285 44.9414 458.686 62.587"
                    fill="none" />
                  <text>
                    <textPath href="#gs-reason-path-03" startOffset="1%" textLength="459"
                      lengthAdjust="spacing">
                      話の合いそうな相手を見つけやすい
                    </textPath>
                  </text>
              ...
              <div class="gs-reason__blob-wrap gs-reason__blob-wrap--04">
                ...
                <svg class="gs-reason__blob-label" viewBox="0 0 492 333" aria-hidden="true"
                  ...
                  <path id="gs-reason-path-04"
                    ...
                    fill="none" />
                  <text>
                    <textPath href="#gs-reason-path-04" startOffset="1%" textLength="326"
                      lengthAdjust="spacing">
                      困ったときに自分を守れる
                    </textPath>
                  </text>
        ...
        <img class="gs-reason__illust" src="<?php echo esc_url( $theme_uri ); ?>/design-assets/illust-page-reason.png" alt="" aria-hidden="true" width="405"
          height="470" data-pop />
            ...
            <li class="faq-preview__item">
              ...
              <div class="faq-preview__answer" id="gs-faq-a-3" hidden>
                ...
                <p>Langmate（ラングメイト）は、日本で開発されたアプリです。
                  <br><br>
                  ※アプリの詳しい機能や特徴については、本ページをご確認ください。
                  <br>
