      ...
      <div class="wrapper">
        ...
        <div class="about-intro__text">
          <p>
            ...
            <br><br>
            2015年のサービス開始以来、日本文化を愛する世界中の親日外国人ユーザーと、実践的な国際交流を楽しみたい日本人ユーザーに支持され、現在では累計400万ダウンロード突破のグローバルプラットフォームへと成長しました。
          </p>
          <p>
            「語学力」と「国際力」をアップデートする場所。「生きた英語や外国語を日常的に学びたい」「海外のリアルな文化に触れたい」「日本にいながら外国人の友達を作りたい」。Langmateは、そんなユーザーの想いに応える国際交流アプリです。
            <br><br>
